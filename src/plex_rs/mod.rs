...
///
/// # Arguments
/// - `client_id`: The Plex client identifier (unique per app install)
...
/// - `app_name`: The display name for your app (shown in Plex login)
///
/// # Returns
...
///     "clientId123",
///     "pinCodeAbc",
///     "https://my-cool-plex-app.com",
///     "My Cool App",
/// );
/// ```
pub fn construct_auth_app_url(
    pin_code: &str,
    // forward_url: &str,
) -> Result<String> {
