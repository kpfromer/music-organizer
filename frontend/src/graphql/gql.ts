...
const documents: Documents = {
    ...
    "\n  query SpotifyAccountsForFilter {\n    spotifyAccounts {\n      id\n      displayName\n      userId\n    }\n  }\n": types.SpotifyAccountsForFilterDocument,
    "\n  query SpotifyPlaylistsForFilter($accountId: Int!) {\n    spotifyPlaylists(accountId: $accountId) {\n      id\n      name\n      trackCount\n    }\n  }\n": types.SpotifyPlaylistsForFilterDocument,
    "\n  query SpotifyUnmatchedTracks($page: Int, $pageSize: Int, $search: String, $hasCandidates: Boolean, $sortByScore: Boolean, $playlistId: Int) {\n    spotifyUnmatchedTracks(page: $page, pageSize: $pageSize, search: $search, hasCandidates: $hasCandidates, sortByScore: $sortByScore, playlistId: $playlistId) {\n      unmatchedTracks {\n        spotifyTrackId\n        spotifyTitle\n        spotifyArtists\n        spotifyAlbum\n        spotifyIsrc\n        spotifyDuration\n        candidates {\n          id\n          localTrack {\n            id\n            title\n            trackNumber\n            duration\n            createdAt\n            album {\n              id\n              title\n              year\n              artworkUrl\n            }\n            artists {\n              id\n              name\n            }\n          }\n          score\n          confidence\n          titleSimilarity\n          artistSimilarity\n          albumSimilarity\n          durationMatch\n          versionMatch\n        }\n      }\n      totalCount\n      page\n      pageSize\n    }\n  }\n": types.SpotifyUnmatchedTracksDocument,
    "\n  query SearchLocalTracksForMatching($search: String!, $page: Int, $pageSize: Int) {\n    searchLocalTracksForMatching(search: $search, page: $page, pageSize: $pageSize) {\n      tracks {\n        id\n        title\n        trackNumber\n        duration\n        createdAt\n        album {\n          id\n          title\n          year\n          artworkUrl\n        }\n        artists {\n          id\n          name\n        }\n      }\n      totalCount\n      page\n      pageSize\n    }\n  }\n": types.SearchLocalTracksForMatchingDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query SpotifyAccountsForFilter {\n    spotifyAccounts {\n      id\n      displayName\n      userId\n    }\n  }\n"): typeof import('./graphql').SpotifyAccountsForFilterDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query SpotifyPlaylistsForFilter($accountId: Int!) {\n    spotifyPlaylists(accountId: $accountId) {\n      id\n      name\n      trackCount\n    }\n  }\n"): typeof import('./graphql').SpotifyPlaylistsForFilterDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query SpotifyUnmatchedTracks($page: Int, $pageSize: Int, $search: String, $hasCandidates: Boolean, $sortByScore: Boolean, $playlistId: Int) {\n    spotifyUnmatchedTracks(page: $page, pageSize: $pageSize, search: $search, hasCandidates: $hasCandidates, sortByScore: $sortByScore, playlistId: $playlistId) {\n      unmatchedTracks {\n        spotifyTrackId\n        spotifyTitle\n        spotifyArtists\n        spotifyAlbum\n        spotifyIsrc\n        spotifyDuration\n        candidates {\n          id\n          localTrack {\n            id\n            title\n            trackNumber\n            duration\n            createdAt\n            album {\n              id\n              title\n              year\n              artworkUrl\n            }\n            artists {\n              id\n              name\n            }\n          }\n          score\n          confidence\n          titleSimilarity\n          artistSimilarity\n          albumSimilarity\n          durationMatch\n          versionMatch\n        }\n      }\n      totalCount\n      page\n      pageSize\n    }\n  }\n"): typeof import('./graphql').SpotifyUnmatchedTracksDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query SearchLocalTracksForMatching($search: String!, $page: Int, $pageSize: Int) {\n    searchLocalTracksForMatching(search: $search, page: $page, pageSize: $pageSize) {\n      tracks {\n        id\n        title\n        trackNumber\n        duration\n        createdAt\n        album {\n          id\n          title\n          year\n          artworkUrl\n        }\n        artists {\n          id\n          name\n        }\n      }\n      totalCount\n      page\n      pageSize\n    }\n  }\n"): typeof import('./graphql').SearchLocalTracksForMatchingDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation AcceptSpotifyMatchCandidate($candidateId: Int!) {\n    acceptSpotifyMatchCandidate(candidateId: $candidateId)\n  }\n"): typeof import('./graphql').AcceptSpotifyMatchCandidateDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation DismissSpotifyUnmatchedTrack($spotifyTrackId: String!) {\n    dismissSpotifyUnmatchedTrack(spotifyTrackId: $spotifyTrackId)\n  }\n"): typeof import('./graphql').DismissSpotifyUnmatchedTrackDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation ManuallyMatchSpotifyTrack($spotifyTrackId: String!, $localTrackId: Int!) {\n    manuallyMatchSpotifyTrack(spotifyTrackId: $spotifyTrackId, localTrackId: $localTrackId)\n  }\n"): typeof import('./graphql').ManuallyMatchSpotifyTrackDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
